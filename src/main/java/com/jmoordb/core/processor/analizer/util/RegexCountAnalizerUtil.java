 ...
 * @author avbravo
 */
public class RegexCountAnalizerUtil {
...
// </editor-fold>
     ...
     * @return
     */
    public static Boolean rulesValid(RegexCount regex, List<String> tokenList, String nameOfMethod,  Boolean haveStringParameters) {
        Boolean isValid = Boolean.FALSE;
        try {
...
// </editor-fold>
    ...
    public static String isValidWhereCharacters(RegexCount regexCount, List<? extends VariableElement> parameters, String nameOfMethod) {
        String message = "";
        try {
            if (regexCount.where().trim().indexOf("(") != -1) {
