 ...
 * @author avbravo
 */
public class QueryAnalizerUtil {
...
// </editor-fold>
    ...
    /**
     * Valida que se cumplan las reglas del query, en cuanto a que elementos deben estar incluidos y en qye posicion
     ...
     * @return 
     */
    public static Boolean rulesValid(Query query, List<String> tokenList, String nameOfMethod, Boolean havePaginationParameters, Boolean haveSortedParameters) {
        Boolean isValid = Boolean.FALSE;
        try {
...
if(!haveSortedParameters){
    ...
    Optional<String> byFound = tokenList
         ...
         if(orderFound.isPresent() || byFound.isPresent()){
            ...
            if (tokenList.size() == 7 && havePaginationParameters && haveSortedParameters && (!isValidPaginationInWhere(query) || !isValidSortedInWhere(query))) {

                return Boolean.FALSE;
            }
            if (tokenList.size() > 7 && havePaginationParameters &&  !isValidPaginationInWhere(query)){
                  return Boolean.FALSE;
            }
            if (tokenList.size() > 7  && haveSortedParameters &&  !isValidSortedInWhere(query)) {
                  return Boolean.FALSE;
            }
            ...
            switch (tokenList.size()) {
                case 3:
                     ...
                     *
                     * @Query(id .eq. @id) findAll(String id)
                     */
                    if (!havePaginationParameters && !haveSortedParameters) {
                         ...
                         *
                         * @Query(pagination .skip. @pagination)
                        ...
                        if (havePaginationParameters) {
                             ...
                             *
                             * @Query(sorted .by. @sorted) findAll(Sorted
                             * sorted)
                             */
    ...
    // <editor-fold defaultstate="collapsed" desc="Boolean isValidLogicalOperator(String query)">
    /**
     *
     * @param query
     ...
     * @active
     */
    public static Boolean isValidLogicalOperator(String query) {
        Boolean isValid = Boolean.FALSE;
        try {
            switch (query) {
                case ".eq.":
...
// </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Boolean compare(String query, String operator)">
     ...
     * @return
     */
    public static Boolean compare(String query, String operator) {
        Boolean isValid = Boolean.FALSE;
        try {
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="Boolean isValidBooleanOperador(String query) ">
    /**
     ...
     * @return
     */
    public static Boolean isValidBooleanOperador(String query) {
        Boolean isValid = Boolean.FALSE;
        try {
            switch (query) {
                case ".and.":
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="Boolean isValidSizeComparative(Integer querySize, Integer parameterSize)>
    /**
     *
     * @param querySize
     * @param parameterSize
     * @return Boolean si los tamaños de parametros y de Query.where cumplen las
     * reglas
     */
    public static Boolean isValidSizeComparative(Integer querySize, Integer parameterSize) {
        Boolean isValid = Boolean.FALSE;
        try {
// query incremento de 4
// paramSize incremento de 1
            if ((querySize == 3 && parameterSize == 1)
                    || (querySize == 7 && parameterSize == 2)
                    || (querySize == 11 && parameterSize == 3)
                    || (querySize == 15 && parameterSize == 4)
                    || (querySize == 19 && parameterSize == 5)) {
                isValid = Boolean.TRUE;
            }
        } catch (Exception e) {
            MessagesUtil.error(MessagesUtil.nameOfClassAndMethod() + " error() " + e.getLocalizedMessage());
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="String  isValidQueryCharacters(Query query, List<? extends VariableElement> parameters, String nameOfMethod)">
    public static String isValidQueryCharacters(Query query, List<? extends VariableElement> parameters, String nameOfMethod) {
        String message = "";
        try {
            if (query.where().trim().indexOf(".limit.") != -1) {
                message = "Methods " + nameOfMethod + "() Not allowed .limit.";

            }
            if (query.where().trim().indexOf(".skip.") != -1) {
                message = "Methods " + nameOfMethod + "() Not allowed .skip.";

            }
            if (query.where().trim().indexOf(".order.") != -1) {
                message = "Methods " + nameOfMethod + "() Not allowed .order.";

            }
            if (query.where().trim().indexOf(".by.") != -1) {
                message = "Methods " + nameOfMethod + "() Not allowed .by.";

            }
            if (query.where().trim().indexOf("(") != -1) {
                message = "Methods " + nameOfMethod + "() Not allowed ) for use in @Query. If you want to combine operations with () use @Lookup instead.";
...
// </editor-fold>
    ...
    // <editor-fold defaultstate="collapsed" desc="Boolean isValidPaginationInWhere(Query query)">
    /**
     ...
     * @return
     */
    public static Boolean isValidPaginationInWhere(Query query) {
        Boolean isValid = Boolean.FALSE;
        try {
            if (query.where().contains(".skip.") || query.where().contains(".limit.")) {
                isValid = Boolean.TRUE;
            }
        } catch (Exception e) {
            MessagesUtil.error(MessagesUtil.nameOfClassAndMethod() + " error() " + e.getLocalizedMessage());
...
// </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Boolean isValidSortedInWhere(Query query)">
     ...
     * @return
     */
    public static Boolean isValidSortedInWhere(Query query) {
        Boolean isValid = Boolean.FALSE;
        try {
            if (query.where().contains(".order.") || query.where().contains(".by.")) {
                isValid = Boolean.TRUE;
            }
        } catch (Exception e) {
            MessagesUtil.error(MessagesUtil.nameOfClassAndMethod() + " error() " + e.getLocalizedMessage());
