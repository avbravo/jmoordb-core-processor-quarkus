...
public class PingAnalizer {
// <editor-fold defaultstate="collapsed" desc="fields()">

    private static Integer MAXIMUM_NUMBER_OF_PARAMETERS = 0;
    ...
    public static void setMessage(String message) {
        PingAnalizer.message = message;
    }
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="analizer(ExecutableElement executableElement,TypeMirror typeEntity)">
    public static Boolean analizer(Ping pingAnnotation, Element element, ExecutableElement executableElement,TypeMirror typeEntity) {
        try {
