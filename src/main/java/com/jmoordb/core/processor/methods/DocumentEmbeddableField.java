...
public class DocumentEmbeddableField {
    ...
    public DocumentEmbeddableField(String returnTypeValue, String nameOfMethod, AnnotationType annotationType, ReturnType returnType, Id id, Column column, Embedded embedded, Referenced referenced, TypeReferenced typeReferenced) {
    ...
    public static class Builder {
        ...
        public DocumentEmbeddableField build() {
            return new DocumentEmbeddableField(returnTypeValue, nameOfMethod, annotationType, returnType, id, column, embedded, referenced, typeReferenced);
